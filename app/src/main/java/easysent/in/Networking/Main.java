...
import static easysent.in.Networking.Helper.multipart.Utils.getParam;
...
import easysent.in.Networking.Helper.ApiClient;
import easysent.in.Networking.Helper.ApiInterface;
import easysent.in.Networking.Helper.ProgressRequestBody;
import easysent.in.Networking.Helper.multipart.PART;
import easysent.in.Networking.Helper.multipart.Params;
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                handler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        onSuccess.OnSucces(call.request().url().toString(), "200", response.body());
